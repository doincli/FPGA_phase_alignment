...
#
# Generated by export_simulation on Thu Aug 11 14:17:04 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './arctan.sh' script.
...
./arctan.sh -noclean_files

For more information on the script, please type './arctan.sh -help'.
