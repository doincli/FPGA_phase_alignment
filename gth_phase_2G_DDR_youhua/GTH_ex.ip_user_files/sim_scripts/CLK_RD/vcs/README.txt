...
#
# Generated by export_simulation on Sun Aug 14 10:43:00 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './CLK_RD.sh' script.
...
./CLK_RD.sh -noclean_files

For more information on the script, please type './CLK_RD.sh -help'.
