...
HD_PWD='C:/Users/loser/Desktop/gth_phase_2G_DDR_youhua/GTH_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GTH_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GTH_exdes.tcl -notrace
