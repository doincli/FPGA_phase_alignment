...
HD_PWD='C:/Users/loser/Desktop/gth_phase_ex/GTH_ex.runs/arctan_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arctan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arctan.tcl
