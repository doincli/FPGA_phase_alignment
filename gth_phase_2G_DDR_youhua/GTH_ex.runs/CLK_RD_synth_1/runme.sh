...
HD_PWD='C:/Users/loser/Desktop/gth_phase_2G_DDR/GTH_ex.runs/CLK_RD_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLK_RD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLK_RD.tcl
