...
HD_PWD='C:/Users/loser/Desktop/gth_phase_2G_DDR_youhua/GTH_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GTH_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GTH_exdes.tcl
